  ...
  return (
    <div className='col-span-12 lg:col-span-6'>
      <div className='relative h-[328px] w-[576px]'>
        <div className='absolute left-0 top-0 z-10 h-[273px] w-[460px] rounded-[12px] bg-gradient-to-b from-start-gradient to-end-gradient p-[1px]'>
          <div className='left-0 top-0 z-10 row-span-1 gap-4 rounded-[12px] bg-[#1A121E] p-6 pt-5'>
        ...
        <div className='absolute bottom-0 right-0 h-[273px] w-[460px] rounded-[12px] bg-gradient-to-b from-start-gradient to-end-gradient p-[1px]'>
          <div className='bottom-0 right-0 gap-4 rounded-[12px] bg-[#1A121E] p-6 pt-5'>
            <div className='mb-4 justify-between gap-2 border-b-[1px] border-[#35243D] pb-4'>
              <div className='col-span-12 text-center'>{t('1 / 2 tasks completed')}</div>
