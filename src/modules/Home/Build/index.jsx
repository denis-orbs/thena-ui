    ...
    <div className='mx-auto w-full max-w-[1152px] px-6 xl:px-0'>
      ...
      <div className='-mt-10 flex w-full flex-row md:mt-0 lg:flex-col'>
        <div className='relative w-0.5 bg-[#1B1624] lg:h-0.5 lg:w-full'>
          <div className='h-[calc(50%+97px)] w-0.5 bg-linear-to-b from-[#DC01D4]/0 to-[#DC01D4] lg:h-full lg:w-1/2 lg:bg-linear-to-r' />
          <div className='absolute top-[calc(50%+87px)] -left-[7px] h-4 w-4 rounded-full bg-[#D702D0] lg:-top-2 lg:left-[calc(50%-8px)]' />
        </div>
        <div className='relative w-full items-start lg:flex lg:w-auto'>
          ...
          <div className='relative z-10 flex w-full flex-row items-center justify-center lg:w-1/3 lg:flex-col'>
            ...
            <div className='w-full rounded-[20px] bg-linear-to-b from-white/[0.08] to-transparent p-px'>
              <div className='rounded-[20px] bg-[rgba(15,7,18,0.45)] px-7 pt-2.5 pb-[22px]'>
                <p className='font-figtree text-lg leading-[48px]! font-bold tracking-[-0.54px] text-[#FC86E2] lg:text-xl lg:tracking-[-0.6px]'>
                  2023
                </p>
                <div className='mt-2.5 w-full'>
                  {q2Data.map((item, idx) => (
                    <div className='flex items-center justify-between py-3' key={idx}>
                      <p className='text-[13px] leading-6 font-medium tracking-[-0.48px] text-white/[0.65] lg:text-base lg:text-white/[0.85]'>
                        {t(item.value)}
                      </p>
                      {item.icon && (
                        <>
          ...
          <div className='relative z-10 mt-6 flex w-full flex-row items-center justify-center lg:mt-0 lg:ml-8 lg:w-1/3 lg:flex-col'>
            <div className='h-0.5 w-6 bg-[#CD07D2] lg:flex lg:h-12 lg:w-0.5'>
              <div className='h-0 w-full bg-[#CD07D2]' />
            </div>
            <div className='w-full rounded-[20px] bg-linear-to-b from-[#CD07D2] to-transparent p-px'>
              <div className='rounded-[20px] bg-[rgba(15,7,18,0.80)]'>
                <div className='rounded-[20px] bg-[rgba(15,7,18,0.55)] px-7 pt-2.5 pb-[22px]'>
                  <p className='font-figtree text-lg leading-[48px]! font-bold tracking-[-0.54px] text-[#FC86E2] lg:text-xl lg:tracking-[-0.6px]'>
                    2024 Q1-Q2
                  </p>
                  <div className='mt-2.5 w-full'>
