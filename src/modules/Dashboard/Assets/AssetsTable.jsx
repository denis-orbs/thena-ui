...
function AssetsTable({ positions = [] }) {
  ...
  return (
    <div className='w-full overflow-x-scroll rounded-lg max-md:px-0'>
      {/* Header */}
      <div className='hidden rounded-lg md:bg-neutral-800 lg:flex lg:px-4'>
        <div className='flex w-full items-center justify-between rounded-lg py-2 text-sm font-semibold'>
          ...
          <span className='w-[24%] max-w-[290px]' />
        </div>
      </div>
      ...
      <div
        className={cn(
          'max-lg:space-y-2 lg:px-4 lg:pt-8',
          'bg-opacity-50 bg-[url(/images/rewards-claimable-bg.png)] bg-contain bg-no-repeat',
        )}
      >
        {renderPosition}
      </div>
