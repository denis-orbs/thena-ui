      ...
      {!Number(liquidity) ? (
        ...
        <div className='flex h-[54px] flex-col items-center justify-center gap-1'>
          ...
          <div className='relative h-5 w-full rounded-md border border-neutral-600 !px-2'>
            <div className='absolute inset-0 h-5 w-full overflow-hidden rounded-md'>
              {/* Background gradient for in-range */}
              <div
                style={{ left: `${outOfRangePosition.percent}%` }}
                className='absolute top-0 z-30 h-full w-full -translate-x-1/2 transform'
              >
                <div
                  className={cn(
            ...
            <div className='relative flex h-5 w-full items-center justify-center overflow-visible'>
              ...
              <div
                ...
                className='absolute -top-5 flex items-center gap-2 text-[10px] leading-4'
              >
              ...
              {/* Range boundaries */}
              <div
                className='bg-warn-950 absolute top-0 flex h-full items-center justify-between'
                style={{
                  left:
              ...
              >
                <HalfPolygonIcon
                  className={cn(
                    'text-warn-700 absolute -bottom-[1px] left-0 z-40 size-4',
                    currentHover === 'min-price' && 'text-warn-600',
                  )}
                ...
                <HalfPolygonIcon
                  className={cn(
                    'text-warn-700 absolute -top-[1px] right-0 z-40 size-4 rotate-180',
                    currentHover === 'max-price' && 'text-warn-600',
                  )}
              ...
              <div
                style={{
                  left: `${outOfRangePosition.percent}%`,
                }}
                className={cn(
                  'absolute top-0 z-30 flex h-full transform items-center justify-center',
              ...
              >
                <PolygonIcon
                  className={cn(
                    'text-primary-300 h-7 w-4 cursor-pointer drop-shadow-[1px_3px_5px_#2c000240] transition-all duration-200 ease-in-out',
              ...
              {currentHover === 'current-price' && (
                ...
                >
                  <div className={cn('relative flex items-center justify-center')}>
                    <span className='text-[10px] leading-4 text-nowrap text-neutral-50'>
          ...
          <div className='relative h-5 w-full rounded-md border border-neutral-600 !px-2'>
            ...
            <div className='relative flex h-5 w-full items-center justify-center overflow-visible'>
              <div className='flex w-full justify-between'>
                <HalfPolygonIcon
                  className={cn(
                    'absolute bottom-[1px] left-0 z-20 size-4 justify-items-start text-neutral-500',
                    currentHover === 'min-price' && 'text-neutral-200',
                  )}
                  onMouseEnter={() => setCurrentHover('min-price')}
                  onMouseLeave={() => setCurrentHover(null)}
                />
                <HalfPolygonIcon
                  className={cn(
                    'absolute -top-[1px] right-0 z-20 size-4 rotate-180 justify-items-end text-neutral-500',
                    currentHover === 'max-price' && 'text-neutral-200',
                  )}
                  onMouseEnter={() => setCurrentHover('max-price')}
                  onMouseLeave={() => setCurrentHover(null)}
                />
              ...
              <div
                style={{ left: currentPercent === 0 ? '0' : `${currentPercent}%` }}
                className={cn(
                  'absolute top-0 flex h-full transform items-center justify-center',
                  // currentPercent < 10 ? 'left-2' : '-translate-x-1/2',
                  // currentPercent > 90 ? 'right-2' : '-translate-x-1/2',
                )}
              >
                <PolygonIcon
                  className={cn(
              ...
              {currentHover === 'min-price' && (
                <div style={{ left: 0 }} className={cn('absolute -top-5 z-20')}>
                  <div className={cn('relative flex items-center justify-center')}>
                    <span className='text-[10px] leading-4 text-nowrap text-neutral-50'>
                      Lower: {formatAmount(minPrice)}
                    </span>
              ...
              {currentHover === 'max-price' && (
                <div style={{ right: 0 }} className={cn('absolute -top-5 z-20')}>
                  <div className={cn('relative flex items-center justify-center')}>
                    <span className='text-[10px] leading-4 text-nowrap text-neutral-50'>
                      Upper: {formatAmount(maxPrice, true)}
                    </span>
