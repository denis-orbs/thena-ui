...
function TheNFT() {
  ...
  const { stakedIds, walletIds, pendingReward } = useTheNftAccountInfo()
  ...
  return (
    <div className='flex h-full flex-col rounded-xl bg-neutral-900 py-4'>
      ...
      <div className='flex h-full flex-col justify-between gap-4'>
        {yourNfts && yourNfts.length > 0 ? (
          <div className='relative flex w-full justify-center overflow-hidden pb-4'>
            <div className='-ml-[10%] flex w-[120%] gap-4'>
