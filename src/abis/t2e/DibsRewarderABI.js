export const DibsRewarderABI = [
  { inputs: [], name: 'DayExpired', type: 'error' },
  { inputs: [], name: 'DayNotFinished', type: 'error' },
  { inputs: [], name: 'InvalidSignature', type: 'error' },
  { inputs: [], name: 'LengthMismatchClaim', type: 'error' },
  { inputs: [], name: 'LengthMismatchFill', type: 'error' },
  { inputs: [], name: 'RewarderInitialized', type: 'error' },
  { inputs: [], name: 'RewarderNotInitialized', type: 'error' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_userVolume', type: 'uint256' },
      { internalType: 'uint256', name: '_totalVolume', type: 'uint256' },
      { internalType: 'uint256', name: '_sigTimestamp', type: 'uint256' },
      ...
      { internalType: 'bytes', name: '_gatewaySignature', type: 'bytes' },
    ],
    name: 'claim',
    outputs: [],
  ...
  },
  {
    inputs: [],
    name: 'currentDay',
    outputs: [{ internalType: 'uint256', name: 'currentday', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  { inputs: [], name: 'initStartTimestamp', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
      { internalType: 'address[]', name: '_tokens', type: 'address[]' },
      { internalType: 'address', name: '_admin', type: 'address' },
      { internalType: 'address', name: '_validMuonGateway', type: 'address' },
