export const VotingIncentiveABI = [
  {
    inputs: [
  ...
  { inputs: [], name: 'NotClaimer', type: 'error' },
  ...
  },
  {
    ...
    name: 'recoverERC20AndUpdateLastIncetive',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'incentivesAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'feesAmount', type: 'uint256' },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_token', type: 'address' },
      { internalType: 'uint256', name: '_timestmap', type: 'uint256' },
    ],
    name: 'rewardPerToken',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
