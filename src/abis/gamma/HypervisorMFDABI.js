export const HypervisorMFDABI = [
  { inputs: [], name: 'ActiveReward', type: 'error' },
  { inputs: [], name: 'AddressZero', type: 'error' },
  { inputs: [], name: 'InsufficientPermission', type: 'error' },
  { inputs: [], name: 'InvalidAmount', type: 'error' },
  { inputs: [], name: 'InvalidBurn', type: 'error' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint8', name: 'fee', type: 'uint8' }],
    name: 'SetFee',
    type: 'event',
  },
  {
  ...
  { inputs: [], name: 'getAllRewards', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: 'getRewardRatesPerSecond',
    outputs: [
      { internalType: 'address[]', name: 'rewardAddresses', type: 'address[]' },
      { internalType: 'uint256[]', name: 'rewardRatesPerSecond', type: 'uint256[]' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  { inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'lastTimeUpdated', type: 'uint256' },
