...
function NewIconGroup({ logo1, logo2, className, classNames, size = 'title' }) {
  return (
    <div className={cn('flex -space-x-1 lg:-space-x-2', size === 'title' && '-space-x-2 lg:-space-x-4', className)}>
      <CircleImage
        className={cn(
          'size-7 rounded-full outline outline-1 outline-[#1C2027] lg:size-12 lg:outline-2',
      ...
      <CircleImage
        className={cn(
          'z-1 -ml-1 size-7 rounded-full outline outline-1 outline-[#1C2027] lg:-ml-2 lg:size-12 lg:outline-2',
