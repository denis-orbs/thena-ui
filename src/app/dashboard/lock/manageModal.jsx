        ...
        <ModalBody>
          <div className={cn('rounded-xl border border-neutral-700 bg-transparent')}>
            {typesData.map((ele, idx) => (
              <div
                className={cn(
                  'hover:bg-opacity-20 flex cursor-pointer items-center gap-4 border-b border-neutral-700 p-6 first:rounded-t-xl last:rounded-b-xl last:border-0 hover:bg-neutral-950',
                )}
                key={`selector-${idx}`}
