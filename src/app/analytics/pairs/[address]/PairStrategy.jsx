    ...
    <div className='flex gap-8 max-lg:flex-col max-lg:gap-4'>
      <div className='w-full lg:max-w-[393px]'>
        <div className={cn('flex items-center justify-between py-4 lg:h-[92px]')}>
          ...
          <EmphasisIconButton
            Icon={ArrowRightIcon}
            className='size-11 bg-neutral-700 [&>svg>path]:stroke-neutral-400 [&>svg]:size-5'
      ...
      <div className='flex w-full flex-col gap-8'>
        <div className={cn('flex items-center justify-between rounded-xl bg-primary-950 bg-opacity-50 p-4 lg:px-6')}>
