...
import { GAMMA_TYPES, PAIR_TYPES, SPECIAL_POOLS } from '@/constant'
import { useManuals } from '@/context/manualsContext'
import { usePairs } from '@/context/pairsContext'
import { useVaults } from '@/context/vaultsContext'
import { cn, formatAmount } from '@/lib/utils'
import PoolsSummary from '@/modules/Pools/PoolsSummary'
...
export default function PoolsPage() {
  ...
  }, [filter, strategy, searchText, pairs])
  ...
  return (
    <div>
      ...
      <div className='mb-24'>
        <PoolsSummary pools={pairs} />
      </div>
      <div className='flex flex-col items-center gap-4 lg:flex-row'>
        <div className='ml-auto flex w-full flex-col gap-4 lg:w-auto lg:flex-row lg:gap-2'>
          <Dropdown
          ...
          <SearchInput placeholder='Search' className='w-full lg:w-[457px]' val={searchText} setVal={setSearchText} />
          {/* <Toggle
        ...
        <div className='flex gap-4 lg:flex-row'>
          ...
          <PrimaryButton onClick={() => push('/pools/add-liquidity')} className='w-full lg:w-auto'>
            {t('Add Liquidity')}
          </PrimaryButton>
          {/* </Link> */}
        </div>
      ...
      <div className='mt-6 flex flex-col gap-4'>
        <NewListings
          title={
            <div className='flex items-center gap-2'>
              <PoolCoinsIcon className='h6 w-6' />
              {t('NORMAL')}
            </div>
          }
          pools={filteredPools}
