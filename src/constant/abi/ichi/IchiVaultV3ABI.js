export const IchiVaultV3ABI = [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'sender', type: 'address' },
      { indexed: false, internalType: 'address', name: 'farmingContract', type: 'address' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'fee',
    outputs: [{ internalType: 'uint24', name: 'fee_', type: 'uint24' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: '_ammFeeRecipient', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'uint32', name: 'newAuxTwapPeriod', type: 'uint32' }],
    name: 'setAuxTwapPeriod',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: '_farmingContract', type: 'address' }],
